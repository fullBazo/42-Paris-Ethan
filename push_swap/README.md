...
Push_swap is a project that aim to sort data in a stack using a limited set of instructions, to achieve the lowest possible number of actions.

INSTRUCTIONS

To test this project, you need to use Makefile :
...
For the majority of this project, my peers were the heart of my learning through this project.

The youtuber Oceano was a great help to understand complicated concept I used :
